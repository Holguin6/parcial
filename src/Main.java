...
public class Main {
    public static void main(String[] args) {
        ...
        Teacher newTeacher = new Teacher(321, "Isabella", "Ingenieria");
        ...
        Enrollment newEnrollment = new Enrollment(432, newStudent.getId(), newCourse.getId());
        enrollmentController.insertNewEnrollment(newEnrollment);
        enrollmentController.displayAllEnrollments();

        GradeType newGradeType = new GradeType(122, "Cuarto Semestre", 27.5);
        gradeTypeController.insertNewGradeType(newGradeType);
        gradeTypeController.displayAllGradeTypes();

        Grade newGrade = new Grade(221, newEnrollment.getId(), newGradeType.getId(), 3.0);
